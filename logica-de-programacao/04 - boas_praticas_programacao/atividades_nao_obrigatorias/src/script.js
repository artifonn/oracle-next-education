...
// Em seguida, armazene a resposta em uma variável e mostre no console do navegador.
  ...
  // let linguagemPredileta = prompt('Qual é a linguagem de programação que você mais gosta?');
  // console.log(`A linguagem de programação que eu mais gosto é ${linguagemPredileta}!`);
...
// 11- Use o Math.random para gerar qualquer número aleatório e exiba esse número no console.
  ...
  // console.log(`O número ${numeroAleatorio} foi gerado aleatóriamente!`);
